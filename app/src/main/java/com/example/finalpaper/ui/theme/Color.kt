...
val ColorBlindRed = Color(0xFFF05039)
val ColorBlindDarkPink = Color(0xFFE57A77)
val ColorBlindPink = Color(0xFFEEBAB4)

val ColorBlindDarkBlue = Color(0xFF1F449C)
val ColorBlindBlue = Color(0xFF3D65A5)
val ColorBlindLightBlue = Color(0xFF7CA1CC)
val ColorBlindBlueGrey = Color(0xFFA8B6CC)
